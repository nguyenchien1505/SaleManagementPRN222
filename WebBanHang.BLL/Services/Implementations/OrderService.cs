...
namespace WebBanHang.BLL.Services.Implementations
{
    public class OrderService : IOrderService
    {
        ...
        public OrderService(IOrderRepository orderRepository, IProductRepository productRepository, WebBanHangContext context, ICoinService coinService, IPromotionService promotionService)
        {
        ...
        public async Task<bool> UpdateOrderStatusAsync(int id, string status)
        {
            ...
            if (status == "Cancelled" && (order.Status == "Paid" || order.Status == "Refunded"))
            {
