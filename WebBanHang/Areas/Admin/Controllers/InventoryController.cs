    ...
    public class InventoryController : Controller
    {
        ...
        public IActionResult Index(int pageNumber = 1)
        {
            var history = _inventoryService.GetHistory()
                ...
                .AsQueryable();
            int pageSize = 15;
            var paged = WebBanHang.Areas.Sale.Models.PaginatedList<WebBanHang.DAL.Entities.InventoryTransaction>.Create(history, pageNumber, pageSize);
            return View(paged); // Tìm file Index.cshtml
        }
